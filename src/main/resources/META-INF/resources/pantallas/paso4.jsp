...
<form action="<%=savePaso2URL%>" method="POST" hidden="true" id="paso3_back">
	<input type="hidden" id="paso" name="paso" class="d-none" value="paso3">
	<input type="hidden" id="folioCoti" name="folioCoti" class="d-none" value="${infCotizacion.folio}">
	<input type="hidden" id="versionCoti" name="versionCoti" class="d-none" value="${infCotizacion.version}">
	<input type="hidden" id="cotizacion" name="cotizacion" class="d-none" value="${infCotizacion.cotizacion}" />
	<input type="hidden" id="infoCotizacion" name="infoCotizacion" class="d-none" value="${infoCoti}">
