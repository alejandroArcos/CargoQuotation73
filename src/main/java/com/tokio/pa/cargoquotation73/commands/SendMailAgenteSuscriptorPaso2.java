...
import com.tokio.pa.cargoquotation73.util.SendMail;
...
@Component(immediate = true, property = {
		...
		"mvc.command.name=/cotizadorTransportistas/sendMailAgenteSuscriptor" }, service = MVCResourceCommand.class)
					...
					try {
						DocumentoResponse respuesta =
								_CMServisGen.wsDocumentos(0, CotizadorModularServiceKey.TMX_CTE_TRANSACCION_POST,
										...
										"DOCTRANSPORTE", (int) infCot.getCotizacion(), "", p_usuario, infCot.getPantalla());
...
//			
	...
	void enviaMails(ResourceRequest resourceRequest){
		...
		try {
			...
			String paso = "/cotizador-transportes";
