...
import com.tokio.pa.cargoquotation73.util.SendMailLegal492;
...
@Component(immediate = true, property = { "javax.portlet.name=" + CargoQuotation73PortletKeys.CotizadorTransportistas,
...
public class SendDocumentosArt492 extends BaseMVCResourceCommand{
	...
	private void actualizaEstatusCotizacion(ResourceRequest resourceRequest) throws CotizadorModularException{
		...
		String p_pantalla = CargoQuotation73PortletKeys.CotizadorTransportistas;
	...
	private void enviaMail(ResourceRequest resourceRequest) throws CotizadorModularException {
		...
		InformacionLegal infLegal = _ServicePaso4.informacionLegal(cotizacion, version, idPerfil, CargoQuotation73PortletKeys.CotizadorTransportistas, usuario);
